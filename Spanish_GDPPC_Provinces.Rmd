...
The dataframe is cleaned for merging with one from mapSpain. This turned out unnecessary because of the mapSpain package having many options for province names in its large dataframes.
